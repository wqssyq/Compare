...
import com.aisino.platform.system.accounts.plugins.GetParamsQueryPlugin;
...
//
	public static HashMap<String, String> hmSQL = new HashMap<String, String>();
	
//	private String getSqlid(String sql){
//		String sqlId = hmSQL.get(sql);
//		
//		if(sqlId==null){
//			hmSQL.put(sql, "SQLID_" + hmSQL.size() + "_");
//			sqlId = hmSQL.get(sql);
//		}
//		return sqlId;
//	}
...
//			logger.debug("Executing prepared SQL statement" + (sql != null ? " [" + sql + "]" : ""));
			//logger.debug("001 Executing prepared SQL statement" + (sql != null ? " [" + sql + "]" : ""));
			
//			if(!hmSQL.containsKey(sql)){
//				try {
//					hmSQL.put(sql, sql);
//					logger.debug("hmSQL.size():" + hmSQL.size());
//					logger.debug("SqlStackTrace", new RuntimeException());
//				} catch (Exception e) {
//					//e.printStackTrace(s);
//				}
//			}
			...
			if(sqlId==null){
				try {
					...
					logger.debug(sqlId, new RuntimeException());
				} catch (Exception e) {
					//e.printStackTrace(s);
				}
			}else{
...
//				try {
//					//Thread.dumpStack();
//					logger.debug("002", new RuntimeException());
//				} catch (Exception e) {
...
//		}
	...
	private void showParam(String sql, Object[] args){
//		if (logger.isDebugEnabled()) {
